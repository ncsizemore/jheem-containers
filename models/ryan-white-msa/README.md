...
`ghcr.io/ncsizemore/jheem-base:1.6.0`, copies the validated workspace from the legacy model image, and
...
| --- | --- | --- |
| `BASE_VERSION` | `1.6.0` | Shared base image version tested for this frozen model. |
